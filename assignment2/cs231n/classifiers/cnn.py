...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params["W1"] = np.random.normal(
            scale=weight_scale, size=(num_filters, C, filter_size, filter_size)
        )
        self.params["b1"] = np.zeros(num_filters)
        # after max-pooling, downsampled 2 times per axis
        self.params["W2"] = np.random.normal(
            scale=weight_scale, size=(num_filters * H * W // 4, hidden_dim)
        )
    ...
    def loss(self, X, y=None):
        ...
        affine, affine_cache = affine_forward(affine_relu, W3, b3)
        scores = affine
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
